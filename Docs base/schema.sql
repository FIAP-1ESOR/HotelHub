-- =============================================================================
-- FlexMedia Hotel Hub
-- schema.sql — Modelo Físico de Banco de Dados (H2) — v2
-- Local: src/main/resources/schema.sql
-- O Spring Boot executa este script automaticamente na inicialização.
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS Reservas_Hospedes (
    ...
    data_entrada_prevista      DATETIME     NOT NULL,
    data_saida_prevista        DATETIME     NOT NULL,
    data_entrada_real          DATETIME,
